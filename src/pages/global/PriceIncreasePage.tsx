  ...
  return (
    <OwnerProtection>
      <section className="pb-20 min-h-screen">
        <Container size="lg">
          <div className="pt-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-2">Повышение цен</h2>
            <p className="text-sm text-gray-500 mb-6">
              Пропорционально изменяет цены в Noona, Strapi addon-groups и offerings. История
              смен, зарплат, pricelist и JSON-LD не затрагиваются.
            </p>
                ...
                <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-sm mb-4">
                  ...
                  <div className="mt-3 flex items-center gap-3">
                    ...
                    <span className="text-xs text-gray-400 ml-4">
                      Положительное — повышение, отрицательное — снижение. Округление до целого:
                      1090 × 1.1 = 1199
                    </span>
                  </div>
                </div>
