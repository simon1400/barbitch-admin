...
const CODE_MESSAGES: Record<string, string> = {
  ...
  booking_has_redemption: 'Na rezervaci už je uplatněna sleva bitchcard — slevy nelze kombinovat.',
  booking_has_discount: 'Na rezervaci už je sleva za dozápis — slevy nelze kombinovat.',
